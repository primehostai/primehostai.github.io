...
2.  Go to **Content compliance** and select **Configure** (or add another rule if you already have rules)
    ...
    2.  Click **Add** in the Expressions tab
...
1.  Click Also deliver to → Add more recipients and add [cohost@primehost.ai](mailto:cohost@primehost.ai)
    
2.  Add a description for your rule e.g bcc com [primehost.ai](http://primehost.ai)
...
**6\. Verify the Forwarding Address:**
...
1.  Go to [https://admin.exchange.microsoft.com/#/transportrules](https://admin.exchange.microsoft.com/#/transportrules)
...
2.  Add a rule:
    ...
    4.  Click Finish and ensure the rule is activated<img src="https://lh7-us.googleusercontent.com/8Jcn566AfwIiNZgF7r3FGpRO3yGqSC19egr-Acl6cgBLX7L_5iCsZvWxnDpJiohOAzIpr8M-rjqQW0BHuav7DNs_Erxumt_DEuVV5e2mlAJXulR7wWUqSF2MmGD1XoD50tsMIH2GT4zmYJt8_aCJJPw" style="margin-left: 0px; margin-top: 0px;" width="663" height="398">